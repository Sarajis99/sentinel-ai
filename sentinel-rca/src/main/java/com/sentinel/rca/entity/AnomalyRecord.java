...
/**
 * Read/update access to the 'anomalies' table.
 * sentinel-rca does NOT own this table (sentinel-detector does),
 * but it updates the 'status' field as part of the lifecycle:
 * DETECTED → INVESTIGATING → INVESTIGATED
 */
@Entity
