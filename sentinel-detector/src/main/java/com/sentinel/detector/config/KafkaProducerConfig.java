...
/**
 * Kafka producer configuration for publishing detected anomalies.
 */
@Configuration
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, AnomalyDTO> anomalyProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, AnomalyDTO> anomalyKafkaTemplate() {
